...
WHITELIST = {
    ...
    # Logs
    "agent_logs": {
        "command": "tail -100 /root/Catalyst-Trading-System-International/catalyst-international/logs/{logfile}.log",
        "description": "Read agent log files",
        "params": ["logfile"],
        "allowed_logfiles": ["agent", "trading", "error", "decisions", "cron", "report"],
        "timeout": 10,
    },
    "system_logs": {
    ...
    "write_file": {
        ...
        "allowed_paths": [
            "/root/Catalyst-Trading-System-International/catalyst-international/scripts/",
            "/root/Catalyst-Trading-System-International/catalyst-international/config/",
            "/root/Catalyst-Trading-System-International/catalyst-international/brokers/",
        ],
